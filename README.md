...
Tenho interesse em **desenvolvimento back-end**, com foco em linguagens como **Java** e **Python**. Atualmente estou aprofundando meus conhecimentos em **Estrutura de Dados com Java**, Fora do ambiente acadêmico, estou investindo no aprendizado de ferramentas essenciais para o mercado, como Git e SQL, por meio de cursos externos. Também estou lendo o livro “Use a Cabeça! Java”, a fim de fortalecer minha base em orientação a objetos e boas práticas de programação.
